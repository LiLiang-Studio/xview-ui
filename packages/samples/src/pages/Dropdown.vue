<template>
  <div>
    ...
    <p>
      ...
      触发对象可以是链接、按钮等各种元素。本例还展示了禁用项和分隔线。</p><br>
    <Dropdown>
    ...
    <div class="page-sub-title">触发方式</div>
    <p>
    ...
    <div class="page-sub-title">对齐方向</div>
    <p>通过设置属性 placement 可以更改下拉菜单出现的方向，与 Poptip 和 Tooltip 配置一致，支持 12 个方向，详见 API。</p><br>
    ...
    <div class="page-sub-title">嵌套用法</div>
    <p>下拉菜单可以进行嵌套实现级联的效果，嵌套时注意设置子集的展开方向</p><br>
    <Dropdown>
      <a href="javascript:void(0)">
        北京小吃
        <Icon type="arrow-down-b"></Icon>
