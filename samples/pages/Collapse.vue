<template>
  <div>
    <div class="page-title">Collapse 折叠面板</div>

    <div class="page-sub-title">默认可以同时展开多个面板，可以设置默认展开第几个</div>
    ...
    <div class="page-sub-title">通过设置属性accordion开启手风琴模式，每次只能打开一个面板。</div>
    ...
    <div class="page-sub-title">折叠面板可以进行嵌套。</div>
    <Collapse accordion v-model="value3">
      <Panel name="1">史蒂夫·乔布斯
        <div slot="content">史蒂夫·乔布斯（Steve Jobs），1955年2月24日生于美国加利福尼亚州旧金山，美国发明家、企业家、美国苹果公司联合创办人。
          <Collapse accordion v-model="value4">
            <Panel name="1-1">iPhone
              <p
                slot="content"
